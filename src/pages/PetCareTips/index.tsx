      ...
      <div className="fh-container">
        <div className="fh-grid">
          <div className="col-span-3">
            <div className="bg-secondaryWhite p-6 rounded-lg shadow-sm border border-primaryCream sticky top-24 overflow-y-auto">
              <h1 className="text-2xl font-bold mb-6 text-primaryDarkRosewood border-b border-primaryCream pb-3">
                Care Categories
              </h1>
              {tabs.map((tab) => (
                <div
          ...
          <div className="col-span-9 col-start-4">
            <div className="bg-secondaryWhite p-8 rounded-lg shadow-sm border border-primaryCream">
              <div className="text-primaryDarkRosewood">
